...

{
    function restartGame() {
        // Reset status game
        gameStatus.points = 0;
        document.getElementById("score").innerHTML = "SCORE: " + gameStatus.points;
        ...
        // Setel ulang tetromino dan mulai ulang interval game
        tetro.position.y = 0;
        tetro.position.x = (W - 48) / 2;
        currTetro = randomizeTetro();

        clearInterval(game); // Hentikan interval sebelumnya
        game = setInterval(updateGameState, 1000 / fps); // Mulai interval baru
    }
